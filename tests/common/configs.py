...
# wrap by function to avoid modified
def get_heartbeat_secs():
    return 1

# wrap by function to avoid modified
def get_expired_time_factor():
    return 60

def get_meta_data_sync_secs():
    return get_heartbeat_secs() * 10

def get_leader_changed_sync_secs():
    return get_heartbeat_secs() * get_expired_time_factor() + get_meta_data_sync_secs()

def get_delay_time():
    return get_meta_data_sync_secs()
